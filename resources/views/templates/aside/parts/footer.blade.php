                        ...
                        <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
                            ...
                            <div class="dropdown" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Languages">
                                <a href="#" class="btn btn-icon btn-lg btn-borderless" data-toggle="dropdown" data-offset="0px,0px">
                                    <img class="w-20px h-20px rounded" src="/metronic/theme/html/demo10/dist/assets/media/svg/flags/226-united-states.svg" alt="image" />
                                </a>
                                <!--begin::Dropdown-->
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-left">
                                    ...
                                    <ul class="navi navi-hover py-4">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo10/dist/assets/media/svg/flags/226-united-states.svg" alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item active">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo10/dist/assets/media/svg/flags/128-spain.svg" alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo10/dist/assets/media/svg/flags/162-germany.svg" alt="" />
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                <span class="symbol symbol-20 mr-3">
                                                    <img src="/metronic/theme/html/demo10/dist/assets/media/svg/flags/063-japan.svg" alt="" />
                                                </span>
