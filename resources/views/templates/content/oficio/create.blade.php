...
@section('header')
    <h2 class="card-label">Guardar oficio</h2>
@endsection
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('oficio.create') }}" class="text-muted">Subir oficio</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="row">
                                    <div class="offset-xxl-2 col-xxl-8">
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                            name="kt_form" method="POST" action="{{ route('oficio.store') }}"
                                            ...
                                            <div class="pb-5" data-wizard-type="step-content"
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="folio" name="folio"
                                                        placeholder="Por Favor introduzca el folio" value="Sin dato">
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="form-group fv-plugins-icon-container has-success">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                placeholder="Por Favor introduzca la hora" value="">
                                            ...
                                            <div class="pb-5" data-wizard-type="step-content"
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="Por Favor introduzca el remitente" value="Sin dato">
                                                ...
                                                <div class="form-group fv-plugins-icon-container has-success">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="Por Favor introduzca el asunto" value="Sin dato">
